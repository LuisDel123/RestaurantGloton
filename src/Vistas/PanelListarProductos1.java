...
public class PanelListarProductos1 extends javax.swing.JPanel {
    String dniPlp;

    public String getDniPlp() {
        return dniPlp;
    }

    public void setDniPlp(String dniPlp) {
        this.dniPlp = dniPlp;
    }

    public PanelListarProductos1() {
        initComponents();

    }

    public PanelListarProductos1(List<Producto> productoPlp1, String cat,String Dni) {
        initComponents();
        setDniPlp(Dni);
        lblCategoria.setText(cat);
        //configurar nombre de platos
        configurarNombrePlatos(productoPlp1);
        //configurar descripcion de platos
        configurarDescripcionPlatos(productoPlp1);
        //configurar imagenes de platos
        congirarImagenesPlatos(productoPlp1);
        //configurar imagenes de platos
        configurarCostoPlatos(productoPlp1);
        //configurar imagenes de platos
        configurarTiempoEntrega(productoPlp1);
    }
    ...
    public void configurarNombrePlatos(List<Producto> Lispr) {
        ...
        for (int i = 0; i < lblNombreplatos.length; i++) {
    ...
    public void configurarDescripcionPlatos(List<Producto> Lispr) {
        ...
        for (int i = 0; i < lblDescripcionPlatos.length; i++) {
    ...
    public void congirarImagenesPlatos(List<Producto> Lispr) {
        ...
        for (int i = 0; i < lblImagenPlatos.length; i++) {
    ...
    public void configurarCostoPlatos(List<Producto> Lispr) {
        ...
        for (int i = 0; i < lblCostoplatos.length; i++) {
    ...
    public void configurarTiempoEntrega(List<Producto> Lispr){
        ...
        for (int i = 0; i < lblTiempoplatos.length; i++) {
    ...
    private void btnPedirPlato1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPedirPlato1ActionPerformed
        String nomProducto=lblNombrePlato1.getText();
        MenuBase mb = new MenuBase(dniPlp,nomProducto);
        mb.setVisible(true);
        JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(PanelListarProductos1.this);
        frame.dispose();
